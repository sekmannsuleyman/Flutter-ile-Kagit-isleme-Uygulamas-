...
class Formguncelle2Cubit extends Cubit{
  Formguncelle2Cubit():super(0);


  var krepo =PlakalardaoRepository();

  Future<void> guncelle(String ekspertizid,  String ekspertizNo,
      String IrsaliyeNo,
    ...
    await krepo.guncelle(ekspertizid,ekspertizNo,IrsaliyeNo,malKabulTarihi, Gelis_yeri, Rutubet, Ymadde, MekanikHamur,Kuse,SinifDisi,PRE,Balya_Sayisi, TSE, Kabul, Kagit_turu, AciklamaKAh, KARISIK,
      KARISIKAdet,
      KARISIKMIX,
      KARISIKMIXAdet,
      KIRPINTIOLUK,
